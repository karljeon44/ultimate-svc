...
import f0 as sovits_f0
from f0 import f0_to_coarse
from modules import commons as commons
from modules.decoders.f0 import F0Decoder
from modules.decoders.hifigan import NSFHifiGANGenerator
from modules.decoders.mb_istft import (
    Multiband_iSTFT_Generator,
    Multistream_iSTFT_Generator,
    iSTFT_Generator,
)
from modules.encoders import Encoder, TextEncoder
from modules.flows import ResidualCouplingBlock
...
class SynthesizerTrn(nn.Module):
    ...
    def forward(self, c, f0, uv, spec, g=None, c_lengths=None, spec_lengths=None):
        ...
        norm_lf0 = sovits_f0.normalize_f0(lf0, x_mask, uv)
    ...
    def infer(self, c, f0, uv, g=None, noice_scale=0.35, predict_f0=False):
        ...
        if predict_f0:
            lf0 = 2595.0 * torch.log10(1.0 + f0.unsqueeze(1) / 700.0) / 500
            norm_lf0 = sovits_f0.normalize_f0(
